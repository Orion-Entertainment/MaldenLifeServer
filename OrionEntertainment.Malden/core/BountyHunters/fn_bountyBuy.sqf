...
if(life_firstHealth < 100000) exitWith {["Sorry! You do not have $100,000 for the license",false,"slow"] call life_fnc_notificationSystem;};
...
if (_action) then {
	...
	life_firstHealth = life_firstHealth - 100000;
