...
_backupmsg setMarkerTextLocal format ["%1 Requesting Backup!", _player getVariable["realname",name _player]];
[1,format["%1 Requested Backup!",name _player]] remoteExecCall ["life_fnc_broadcast",west];
[1,format["%1 Requested Backup!",name _player]] remoteExecCall ["life_fnc_broadcast",west];
uiSleep _deleteTime;
