...
Orion_Life_Phone_Config = [
	["1","if (isNil 'life_action_gangInUse') then {if (isNil {(group player) getVariable 'gang_owner'}) then {createDialog 'Life_Create_Gang_Diag';} else {[] spawn life_fnc_gangMenu;};}; _d = findDisplay -1; _d closeDisplay 1","Gang","images\textures\Phone\subIcons\p_Gang.paa","side player == civilian"],
	["2","[] call life_fnc_groupMenu; _d = findDisplay -1; _d closeDisplay 1","Group","images\textures\Phone\subIcons\p_Group.paa","side player == civilian"],
	...
	["6","createDialog 'phone'; _d = findDisplay -1; _d closeDisplay 1","Chat","images\textures\Phone\subIcons\p_Chat.paa",""],
	...
	["22","[] call life_fnc_settingsMenu; _d = findDisplay -1; _d closeDisplay 1","Settings","images\textures\Phone\subIcons\p_Settings.paa",""],
