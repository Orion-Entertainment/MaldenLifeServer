...
Orion_Life_Phone_Config = [
	...
	["3","createDialog 'Life_Cop_Placeables'; _d = findDisplay -1; _d closeDisplay 1","Barrier","images\textures\Phone\subIcons\p_Barrier.paa",""],
	["4","createDialog 'Life_my_smartphone'; _d = findDisplay -1; _d closeDisplay 1","Chat","images\textures\Phone\subIcons\p_Chat.paa",""],
	["5","createDialog 'life_my_group_Diag'; _d = findDisplay -1; _d closeDisplay 1","Group","images\textures\Phone\subIcons\p_Group.paa",""],
	...
	["77","createDialog 'life_wanted_menu'; _d = findDisplay -1; _d closeDisplay 1","Wanted","images\textures\Phone\subIcons\p_Wanted.paa",""]
];
