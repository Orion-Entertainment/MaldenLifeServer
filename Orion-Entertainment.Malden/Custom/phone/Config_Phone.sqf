...
Orion_Life_Phone_Config = [
	...
	["0","","Market is Disabled","Resources\p_Market.paa",""],
	...
	["77","createDialog 'life_wanted_menu'; _d = findDisplay -1; _d closeDisplay 1","Wanted","images\textures\Phone\subIcons\p_Wanted.paa","side player == west"]
];
