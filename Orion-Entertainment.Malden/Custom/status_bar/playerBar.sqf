...
waitUntil{isNull (findDisplay 38500)};
	...
	while {true} do 
	{
		...
		((uiNamespace getVariable "statusBar")displayCtrl 55555)ctrlSetStructuredText parseText 
			...
			<t shadow='1' shadowColor='#000000' color='%10'><img size='1.6'  shadowColor='#000000' image='Custom\status_bar\images\players.paa' color='%10'/> %2</t>
			<t shadow='1' shadowColor='#000000' color='%11'><img size='1.6'  shadowColor='#000000' image='Custom\status_bar\images\police.paa' color='%11'/> %3</t> 
			<t shadow='1' shadowColor='#000000' color='%11'><img size='1.6'  shadowColor='#000000' image='Custom\status_bar\images\medic.paa' color='%11'/> %4</t> 
			<t shadow='1' shadowColor='#000000' color='%11'><img size='1.6'  shadowColor='#000000' image='Custom\status_bar\images\civil.paa' color='%11'/> %5</t> 
			<t shadow='1' shadowColor='#000000' color='%10'><img size='1.6'  shadowColor='#000000' image='Custom\status_bar\images\money.paa' color='%10'/> %6</t> 
			<t shadow='1' shadowColor='#000000' color='%12'><img size='1.6'  shadowColor='#000000' image='Custom\status_bar\images\bank.paa' color='%12'/> %11</t>  
			<t shadow='1' shadowColor='#000000' color='%10'><img size='1.6'  shadowColor='#000000' image='Custom\status_bar\images\ts3.paa' color='%10'/>ts.orion-entertainment.net</t>",
					"%", 
					_players,
					_polis,
					_doktor,
