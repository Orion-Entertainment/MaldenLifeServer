...
/* System Settings */
    ...
    respawn_timer = 15; //How many seconds a player should wait, before being able to respawn. Minimum 5 seconds.
    ...
    crimes[] = {
		...
		{"STR_Crime_480b","500","481"}, // Hit and Run Personal Injury
