...
if (_action) then {
    if (goToShopView < _upgradePrice) exitWith {
        hint parseText format [
            ...
            [goToShopView] call life_fnc_numberText,
            [_upgradePrice - goToShopView] call life_fnc_numberText
        ];
    };
    goToShopView = goToShopView - _upgradePrice;
